...
class PaymentTransaction(models.Model):
    """Model to track Midtrans payment transactions"""
    STATUS_CHOICES = [
        ('pending', 'Pending'),
        ('capture', 'Capture'),
    ...
    # Additional data
    response_midtrans = models.JSONField(
        null=True,
        blank=True,
    ...
    def is_paid(self):
        ...
        return self.transaction_status in ['capture', 'settlement']
    ...
    def get_status_display_class(self):
        ...
        return status_classes.get(self.transaction_status, 'secondary')
