...
ALLOWED_HOSTS = os.getenv("ALLOWED_HOSTS", "localhost,127.0.0.1").split(",")  # Allow all hosts for development/testing
...
# Folder hasil collectstatic (dipakai Render)
STATIC_ROOT = BASE_DIR / "staticfiles"

# Folder static asli project (yang sekarang kamu pakai)
STATICFILES_DIRS = [BASE_DIR / "static"]

MEDIA_URL = "/media/"
MEDIA_ROOT = BASE_DIR / "media"

# Storage untuk Whitenoise (compress + hash)
